...
import { img, localid, value } from 'pages/publish/actionCreator'
...
class ChatWinBars extends React.Component {
    constructor(props) {
        super(props);
    ...
    render() {
        var height = 50//this.props.focus ? 234 : 50
        return (
...
export default connect(mapState, mapDispatch)(ChatWinBars)
